...
//
// ============================================================================
package org.talend.designer.unitemap.language.postgres;
...
public class PostgresGenerationManager extends DbGenerationManager {
    ...
    private String replaceFields4Expression(UniteMapComponent component, String expression, String subExpression) {
    ...
    protected String getHandledTableName(UniteMapComponent component, String tableName, String aliasName, boolean generateSubSql) {
        List<IConnection> inputConnections = (List<IConnection>) component.getIncomingConnections();
        if (inputConnections == null) {
            return tableName;
        }
    ...
    private void generateSubQuery(UniteMapComponent component, StringBuffer sb, INode source, IConnection iconn, String tableName,
            String aliasName) {
